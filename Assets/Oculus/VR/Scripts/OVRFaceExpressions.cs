...
public class OVRFaceExpressions : MonoBehaviour, IReadOnlyCollection<float>
{
    ...
    private void Update()
    {
        ...
        //if (ValidExpressions)
        //{
        //    for (int i = 0; i < _currentFaceState.ExpressionWeights.Length; i++)
        //    {
        //        Debug.Log(Enum.GetName(typeof(FaceExpression), i) + ": " + _currentFaceState.ExpressionWeights[i]);
        //    }
        //    foreach (float expressionWeightConfidence in _currentFaceState.ExpressionWeightConfidences)
        //    {
        //        Debug.Log(expressionWeightConfidence);
        //    }
        //}
    }
