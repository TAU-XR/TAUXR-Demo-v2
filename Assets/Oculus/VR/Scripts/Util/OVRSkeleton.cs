    ...
    private void InitializeCapsules()
    {
        ...
        if (_enablePhysicsCapsules)
        {
            if (!_capsulesGO)
            {
                ...
                _capsulesGO.gameObject.tag = "Toucher";
            }
            ...
            for (int i = 0; i < _capsules.Count; ++i)
            {
                ...
                if (capsule.CapsuleRigidbody == null)
                {
                    ...
                    capsule.CapsuleRigidbody.gameObject.tag = "Toucher";
                }
                ...
                if (capsule.CapsuleCollider == null)
                {
                    ...
                    capsule.CapsuleCollider.isTrigger = true; //in original version this is false, true in order to trigger buttons
                    capsule.CapsuleCollider.gameObject.tag = "Toucher";
                }
