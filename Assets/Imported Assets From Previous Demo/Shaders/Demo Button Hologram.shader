Shader "Custom/DemoButtonHologram" {
	Properties {
		[Header(Holo Section)]
		[Space(10)]
		...
		[PerRendererData] _HoloDistance ("Holo Distance", Range(0,1)) = 0.5
		...
		[Space(10)]
		[PerRendererData] _GlitchStrength("Glitch Strength", Range(0,0.1)) = 0
